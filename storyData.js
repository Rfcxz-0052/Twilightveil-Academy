const storyNodes = {
    ...
    node06: {
        ...
        characterImg: "image/girl01.webp",
        choices: [
            { text: "你這麼努力，你代替我，你的努力也白費了", next: "node08" },
            { text: "快逃！", next: "node07" }
        ]
    },
    ...
    node07: {
        ...
        characterImg: "image/girl01.webp",
        choices: [
            { text: "這不是你的命運，你要守護自己的努力", next: "node08" },
            { text: "繼續逃跑", next: "node08" }
        ]
    },
    ...
    node19: {
        ...
        characterImg: "image/girl01.webp",
        choices: [
            { text: "我微笑地對小英說:小英，下輩子一定要幸福喔!!", next: "node20" }
        ]
    },
